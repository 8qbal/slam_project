...
from .spot_vslam_marl_env_cfg import SpotVslamMarlEnvCfg


class SpotVslamMarlEnv(DirectMARLEnv):
    cfg: SpotVslamMarlEnvCfg

    def __init__(self, cfg: SpotVslamMarlEnvCfg, render_mode: str | None = None, **kwargs):
