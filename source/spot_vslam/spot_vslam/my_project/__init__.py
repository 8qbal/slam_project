...
gym.register(
    id="Spot-v0",
    entry_point=f"{__name__}.envs:ManagerBasedRLEnv",
...
gym.register(
    id="Spot-test180-v0",
    entry_point="spot_vslam.my_project.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={"env_cfg_entry_point": f"{__name__}.cfg.spot_vslam_test_cfg:SpotSlamTestEnvCfg"},
)
